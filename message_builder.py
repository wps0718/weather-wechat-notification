...
class MessageBuilder:
    ...
    def get_daily_note(self) -> str:
        """根据星期几返回每周循环的问候语"""
        weekday = datetime.now().weekday()  # 0-6，0是周一，6是周日
        weekly_notes = [
            "新的一周开始啦，愿你元气满满，工作顺利！💪",  # 周一
            "周二加油，保持好心情，一切都会更好！🌈",      # 周二
            "一周已过半，继续坚持，你会做得很棒！✨",      # 周三
            "周四了，再坚持一下，周末即将到来！🌟",        # 周四
            "周五到了，辛苦了一周，即将迎来休息时光！🎉",  # 周五
            "周末愉快，好好放松，享受美好时光！🏖️",        # 周六
            "周日安康，愿你度过平静美好的一天，为新的一周做好准备！🌸"  # 周日
        ]
        return weekly_notes[weekday]
